 ...
 * @Version: 1.000
 */
public class DefWriteBodyRowDateIntecepter1 implements ProxyMethodIntecepter {

    @Override
    public InteceptReturnVO preHandle(IntecepterArgsVO intecepterArgs) {
        //
        System.out.println("DefWriteBodyRowDateIntecepter1 preHandle");
        return null;
    }
    ...
    public InteceptReturnVO afterHandle(Object retValue, IntecepterArgsVO intecepterArgs) {
        //
        System.out.println("DefWriteBodyRowDateIntecepter1 afterHandle");
        return null;
    }
}
